...
namespace Handlebars.WebApi
{
    ...
    /// </summary>
    public class JsonWithCacheResultExecutor
    {
        ...
        public JsonWithCacheResultExecutor(
            IHttpResponseStreamWriterFactory writerFactory,
            ILogger<JsonWithCacheResultExecutor> logger,
        ...
        public Task ExecuteAsync(ActionContext context, JsonResult result)
        {
            ...
            using (var writer = WriterFactory.CreateWriter(response.Body, resolvedContentTypeEncoding))
            {
                ...
                using (var jsonWriter = new JsonTextWriter(manyWriter))
                {
                    ...
                    if (context.HttpContext.Items.ContainsKey("cache"))
                        context.HttpContext.Items["cache"] = body;
                }
            }
